...
const statusMap = {
  ...
  UPDATE_REQUESTED: 'border-brand-200 bg-brand-100 text-brand-700',
  modification_requested: 'border-brand-200 bg-brand-100 text-brand-700',
  MODIFICATION_REQUESTED: 'border-brand-200 bg-brand-100 text-brand-700',
  ...
  '등록요청 결재대기': 'border-sky-200 bg-sky-50 text-sky-700',
  '수정요청 결재대기': 'border-brand-200 bg-brand-100 text-brand-700',
  '삭제요청 결재대기': 'border-rose-200 bg-rose-50 text-rose-700',
  '등록요청 승인': 'border-green-200 bg-green-50 text-green-700',
  '수정요청 승인': 'border-green-200 bg-green-50 text-green-700',
  '삭제요청 승인': 'border-green-200 bg-green-50 text-green-700',
  '등록요청 반려': 'border-rose-200 bg-rose-50 text-rose-700',
  '수정요청 반려': 'border-rose-200 bg-rose-50 text-rose-700',
  '삭제요청 반려': 'border-rose-200 bg-rose-50 text-rose-700',
